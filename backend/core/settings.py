...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-v1!_s@ul3dihbc_fwky_s@-bsak$e4aqf_g7772f(u*7%$zzrv",
)
...
# Asegurar que siempre incluya localhost y 127.0.0.1 en desarrollo
if DEBUG:
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",  # Frontend principal
    "http://127.0.0.1:3001",
    "http://127.0.0.1:5173",  # Vite dev server alternativo
    "https://almonacidesteban.github.io",  # GitHub Pages
]
...
# Configuración de CSRF para el frontend
